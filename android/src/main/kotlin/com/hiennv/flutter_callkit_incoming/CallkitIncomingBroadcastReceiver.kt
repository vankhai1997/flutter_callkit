...
class CallkitIncomingBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_CLICK_OPEN_CURRENT_CONVERSATION =
        ...
        const val EXTRA_CALLKIT_IS_SHOW_MISSED_CALL_NOTIFICATION =
            "EXTRA_CALLKIT_IS_SHOW_MISSED_CALL_NOTIFICATION"
        ...
        fun getIntentOpenCurrentConversation(context: Context, data: Bundle?) =
            Intent(context, CallkitIncomingBroadcastReceiver::class.java).apply {
                action = ACTION_CLICK_OPEN_CURRENT_CONVERSATION
                putExtra(EXTRA_CALLKIT_INCOMING_DATA, data)
            }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (action) {
            ...
            ACTION_CLICK_OPEN_CURRENT_CONVERSATION -> {
                try {
                    callkitNotificationManager.clearMissCallNotification(data)
                    Log.d("=====", "========$data");

                    sendEventFlutter(ACTION_CLICK_OPEN_CURRENT_CONVERSATION, data)
